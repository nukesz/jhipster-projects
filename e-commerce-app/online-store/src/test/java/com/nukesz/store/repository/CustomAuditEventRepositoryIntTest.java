...
import com.nukesz.store.config.audit.AuditEventConverter;
import com.nukesz.store.domain.PersistentAuditEvent;
...
import static com.nukesz.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
